...
// POOLS
#define LIFE_LEDS 3
int lifeLEDs[LIFE_LEDS] = { 27, 33, 32 };  // these numbers are Arduino GPIO numbers...this is not used in the B. Dring enclosure design
...
void getInput() {
  ...
  ax = accel.acceleration.x * SCALE;
  ay = accel.acceleration.y * SCALE;
  az = accel.acceleration.z * SCALE;
  gx = gyro.gyro.x * SCALEGYRO;
  gy = gyro.gyro.y * SCALEGYRO;
  gz = gyro.gyro.z * SCALEGYRO;
...
#ifdef JOYSTICK_DEBUG
  Serial.print(" tilt:"); Serial.print(joystickTilt); Serial.print(" ");
